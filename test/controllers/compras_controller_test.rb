...
class ComprasControllerTest < ActionController::TestCase
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post :create, compra: { fecha: @compra.fecha, monto_iva: @compra.monto_iva, monto_total: @compra.monto_total, proveedor_id: @compra.proveedor_id, tipo: @compra.tipo }
    end
  ...
  test "should update compra" do
    patch :update, id: @compra, compra: { fecha: @compra.fecha, monto_iva: @compra.monto_iva, monto_total: @compra.monto_total, proveedor_id: @compra.proveedor_id, tipo: @compra.tipo }
    assert_redirected_to compra_path(assigns(:compra))
  end
