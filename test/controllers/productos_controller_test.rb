...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { actual: @producto.actual, costo: @producto.costo, nombre: @producto.nombre, precio: @producto.precio, tipo: @producto.tipo }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { actual: @producto.actual, costo: @producto.costo, nombre: @producto.nombre, precio: @producto.precio, tipo: @producto.tipo }
    assert_redirected_to producto_path(assigns(:producto))
  end
